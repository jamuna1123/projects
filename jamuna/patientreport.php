...
<hr>
	<table>
		<tr>
			<td>
		<a href="prescription.php?patientid=<?php echo $_GET['patientid']; ?>&appid=<?php echo $rsappointment['appointmentid']; ?>">add prescription record</a>
    </td>
...
<hr>
	<table>
		<tr>
			<td>
		<a href="billing.php?patientid=<?php echo $_GET['patientid']; ?>&appid=<?php echo $rsappointment['appointmentid']; ?>">Add Billing record</a>
    </td>
    ...
    ?>
                  ...
                  ?>
                    &nbsp;Tk. <?php echo $billamt; ?></td>
                      ...
                      <tr>
                        <th rowspan="3" scope="col">Grand Total&nbsp;</th>
                         <th scope="col"><div align="right">Grand Total &nbsp; </div></th>
