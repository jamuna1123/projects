...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="view-pending-appointment.php?id=<?php echo $_GET['delid']; ?>" class="button button--success" data-for="js_success-popup">Yes</a>
...
<tbody>
  <?php
    ...
    while($rs = mysqli_fetch_array($qsql))
    {
      ...
      // $sqldept = "SELECT * FROM appointment WHERE appointmentid='$rs[appointmentid]' and delete_status='0'";
      // $qsqldept = mysqli_query($conn,$sqldept);
      // $rsdept = mysqli_fetch_array($qsqldept);
      ...
      if($rs['status'] != "Approved")
      {
         ...
         echo "  <a href='view-appointments.php?delid=$rs[appointmentid]'>Delete</a>";
      }
      else
      {
