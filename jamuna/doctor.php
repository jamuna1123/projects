...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input type="text" class="form-control" name="doctorname" id="doctorname" placeholder="Enter name...." pattern="[a-zA-Z\s]+$" required=""  value="<?php if(isset($_GET['editid'])) { echo $rsedit['doctorname']; } ?>" >
            <span class="messages"></span>
        </div>

        <label class="col-sm-2 col-form-label">Mobile No</label>
        <div class="col-sm-4">
            <input type="text" class="form-control" name="mobilenumber" id="mobilenumber" placeholder="Enter mobilenumber...."  minlength="10" maxlength="10" pattern="^[0][1-9]\d{9}$|^[1-9]\d{9}$" required="">
            <span class="messages"></span>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input class="form-control" type="email" name="loginid" id="loginid" required="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" value="<?php if(isset($_GET['editid'])){ echo $rsedit['loginid'];} ?>"/>
            <span class="messages"></span>
        </div>
    </div>
...
<?php } ?>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input class="form-control" type="text" name="education" id="education" required="" value="<?php 
            if(isset($_GET['editid'])) { echo $rsedit['education']; } ?>" />
        </div>

        <label class="col-sm-2 col-form-label">Experience</label>
        <div class="col-sm-4">
            <input class="form-control" type="text" name="experience" id="experience" required="" value="<?php if(isset($_GET['editid'])) { echo $rsedit['experience']; } ?>"/>
        </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input class="form-control" type="text" name="consultancy_charge" id="consultancy_charge" required=""  value="<?php if(isset($_GET['editid'])) { echo $rsedit['consultancy_charge']; } ?>"/>
        </div>        
