 ...
 ?>
    <div class="popup popup--icon -success js_success-popup popup--visible">
      ...
      <div class="popup__content">
        ...
        <p>
         <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
         <?php echo "<script>setTimeout(\"location.href = 'view-appointment-approved.php';\",1500);</script>"; ?>
        </p>
      </div>
    </div>
 <?php
...
<li class="breadcrumb-item"><a href="#">Appointment Approved</a>
</li>
</ul>
</div>
</div>
...
<?php
        ...
        while($rs = mysqli_fetch_array($qsql))
        {
          ...
          {
            echo "<a href='patientreport.php?patientid=$rs[patientid]&appointmentid=$rs[appointmentid]' class='btn btn-xs btn-primary'>View Report</a> <a href='view-pending-appointment.php?id=$rs[appointmentid]' class='btn btn-xs btn-danger'>Delete</a>";
