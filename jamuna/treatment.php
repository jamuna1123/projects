...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="treatmenttype" id="treatmenttype" required=""
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="treatmentcost" id="treatmentcost" required=""
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <textarea class="form-control" name="note" id="note" required=""><?php if(isset($_GET['editid'])) { echo $rsedit['note']; } ?></textarea>
            <span class="messages"></span>
        </div>
    </div>
