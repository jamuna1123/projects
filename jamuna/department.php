...
?>
            <div class="popup popup--icon -success js_success-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>Hospital Record Updated Successfully</p>
                <p>
...
?>
        <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Hospital Record Inserted Successfully</p>
            <p>
             <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
             <?php echo "<script>setTimeout(\"location.href = 'view-department.php';\",1500);</script>"; ?>
            </p>
...
<li class="breadcrumb-item"><a>Hospital</a>
</li>
<li class="breadcrumb-item"><a href="#">Add Hospital</a>
</li>
</ul>
</div>
</div>
...
<form id="main" method="post" action="" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text" class="form-control" name="departmentname" id="departmentname" placeholder="Enter name...."  pattern="[a-zA-Z\s]+" required=""  value="<?php if(isset($_GET['editid'])) { echo $rsedit['departmentname']; } ?>" >
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <textarea name="description" id="description" class="form-control" required=""><?php if(isset($_GET['editid'])) { echo $rsedit['description']; } ?></textarea>
            <span class="messages"></span>
        </div>
    </div>
