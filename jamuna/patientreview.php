...
if(isset($_GET['id']))
{
  $sql ="UPDATE testing1 SET delete_status='1' WHERE review_id='$_GET[id]'";
    ...
    ?>
         <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>review record deleted successfully.</p>
            <p>
             <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
             <?php echo "<script>setTimeout(\"location.href = 'patientreview.php';\",1500);</script>"; ?>
            </p>
          </div>
        </div>
<?php
...
<li class="breadcrumb-item"><a>review</a>
</li>
...
<?php
  ...
  while($rs = mysqli_fetch_array($qsql))
  {
    ...
    $sqldept = "SELECT * FROM testing1 WHERE review_id='$rs[review_id]'";
    $qsqldept = mysqli_query($conn,$sqldept);
    $rsdept = mysqli_fetch_array($qsqldept);
    echo "<tr>
    <td>&nbsp;$rs[doctorname]</td>
    <td>&nbsp;$rs[average_rating]</td>
    <td>&nbsp;$rsdept[user_review]</td>
