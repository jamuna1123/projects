...
if(isset($_POST['submit']))
{
  ...
  {
      $sql ="UPDATE prescription_records SET prescription_id='$_POST[prescriptionid]',medicine_name='$_POST[medicineid]',cost='$_POST[cost]',unit='$_POST[unit]',dosage='$_POST[select2]',status=' $_POST[select]' WHERE prescription_record_id='$_GET[editid]'";
...
?>
        <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>Prescription record update successfully.</p>
            <p>
...
?>  
        <div class="popup popup--icon -success js_success-popup popup--visible">
          ...
          <div class="popup__content">
            ...
            <p>
             <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
             <?php echo "<script>setTimeout(\"location.href = 'prescriptionrecord.php?prescriptionid=$_GET[prescriptionid]&patientid=$_GET[patientid]&appointmentid=$_GET[appointmentid]';\",1500);</script>"; ?>
            </p>
          </div>
        </div>
<?php
...
{ 
   ...
   $sql ="DELETE prescription_records  WHERE prescription_records_id='$_GET[delid]'";
   $qsql=mysqli_query($conn,$sql);
  if(mysqli_affected_rows($conn) == 1)
  {
  ?>
...
<div class="popup popup--icon -question js_question-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <a href="prescriptionrecord.php?delid=<?php echo $_GET['delid']; ?>" class="button button--success" data-for="js_success-popup">Yes</a>
      <a href="prescriptionrecord.php" class="button button--error" data-for="js_success-popup">No</a>
    </p>
  </div>
</div>
<div class="popup popup--icon -success js_success-popup popup--visible">
      ...
      <div class="popup__content">
        ...
        <p>prescription record deleted successfully</p>
...
<form method="post" action="" name="frmpresrecord" onSubmit="return validateform()"> 
  <input type="hidden" name="prescriptionid" value="<?php echo $_GET['prescriptionid']; ?>"  />
    ...
    ?>
        ...
        <tr>
          <td>Cost</td>
          <td><input class="form-control" type="text" name="cost" id="cost"  style="background-color:pink;" /></td>
        </tr>
        <tr>
          <td>Unit</td>
        ...
        <tr>
          <td>Total Cost</td>
          <td><input class="form-control" type="text" name="totcost" id="totcost" value="<?php if(isset($_GET['editid'])) { echo $rsedit['cost']; } ?>"  style="background-color:pink;" /></td>
        </tr>
        <tr>
          <td>Dosage</td>
     ...
     if(isset($_GET['prescriptionid']))
{
    ...
    while($rs = mysqli_fetch_array($qsql))
    {
      ...
      if(!isset($_SESSION['patientid']))
      {
       echo " <td>&nbsp; <a href='prescriptionrecord.php?editid=$rs[prescription_record_id]&prescriptionid=$_GET[prescriptionid]'>Edit</a>/ 
       <a href='prescriptionrecord.php?delid=$rs[prescription_record_id]&prescriptionid=$_GET[prescriptionid]'>Delete</a> </td>"; 
      }
    echo "</tr>";
