...
<form id="main" method="post" action="" enctype="multipart/form-data">
    <?php
        ...
        if(isset($_GET['patid']))
        {
            $sqlpat= "SELECT * FROM patient WHERE patientid='".$_GET['patid']."'";
            $qsqlpat = mysqli_query($conn,$sqlpat);
            $rspat=mysqli_fetch_array($qsqlpat);
            echo $rspat['patientname'] . " (Patient ID - $rspat[patientid])";
            echo "<input type='hidden' name='select4' value='$rspat[patientid]'>";
        }
    ...
    ?>
     <div class="form-group row">
        ...
        <div class="col-sm-4">
             ...
             <input placeholder="Patient's Name" type="text" class="form-control" name="patient" id="patient"
