  ...
  <?php
    ...
    ?>
      &nbsp;Tk. <?php echo $billamt; ?></td> -->
            ...
            <tr>
              <th width="442" scope="col"><div align="right">Tax Amount</div></th>
              <td width="413">&nbsp;</td>
          ...
          <table id="dom-jqry" class="table table-striped table-bordered nowrap">
            ...
            <tbody>
              <tr>
                ...
                <td><input class="form-control" name="dischargedate" type="text" id="dischargedate" value="<?php echo date("Y-m-d"); ?>"></td>
              </tr>
              <tr>
                <td>Discharge time</td>
                <td><input class="form-control" name="dischargetime" type="text" id="dischargetime" value="<?php echo date("h:i:s"); ?>" ></td>
              </tr>
              <tr>
                <td>Balance amount</td>
                <td><input class="form-control" name="balamt" type="text" id="balamt" value="<?php echo $balanceamt; ?>"  onkeyup="calculatepayable()"></td>
              </tr>
              <tr>
                <td>Discount *</td>
